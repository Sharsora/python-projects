...
- if you divide the number using floor division the last number will be removed from the given number. Suppose number n = 12359 and if you do n // 10 = 1235, 9 will be removed because in-floor division you will not get .9 and we will count till the number becomes 0 
